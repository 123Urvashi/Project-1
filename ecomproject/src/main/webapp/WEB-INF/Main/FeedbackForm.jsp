	...
	<div class="row">
		...
		<div class="col-md-4">
			<form>
				...
				<address>
					<strong>Fragnances Forever</strong><br> NIIT, Preet Vihar<br>
					New Delhi, India <br> <abbr title="Phone"> P:</abbr>
					+918810617980
				</address>
				<address>
					<strong>Full Name</strong><br> <a href="mailto:#">urvashi.gupta@fragnanceforever.com</a>
				</address>
			</form>
		</div>
	</div>
